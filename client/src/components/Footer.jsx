    ...
    <div className="font-sans">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 z-10 relative">
          ...
          >
            Let's Start the <span className="text-amber-600">Journey</span>{" "}
            Today!
          </motion.h2>
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-10">
            ...
            <motion.div className="flex flex-col gap-6" variants={itemVariants}>
              ...
              <p className="text-gray-600 max-w-xs">
                Helping students craft compelling stories for college
                admissions.
              </p>
            ...
            >
              <motion.div variants={itemVariants}>
                ...
                <ul className="space-y-3">
                  <motion.li
                    whileHover={{ x: 5 }}
                    className="hover:text-[#ED6308] transition-colors cursor-pointer"
                  >
                    Contact us
                  </motion.li>
                  <motion.li
          ...
          >
            <div className="md:w-3/4">
              ...
              <p className="text-gray-700">
                RK Editing is 100% legal service. We do NOT write essays for
                you. Instead, we provide editing and proofreading services to
                improve your original essay. We do not guarantee admissions.
              </p>
            </div>
            <motion.img
              src={img3}
